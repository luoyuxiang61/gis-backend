...
let layerRoute = express.Router()


// 根据权限组groupId，返回该权限组拥有的所有图层，以及在相应图层拥有的字段
layerRoute.post('/layersForGroup', (req, res) => {
...
// 获取所有要素图层
layerRoute.get('/featureLayers', (req, res) => {
...
layerRoute.get('/layersForTree', (req, res) => {
...
// 根据图层组ID获取所有子图层
layerRoute.get('/layersInLyrGrp', (req, res) => {
  BaseMapLayer.findAll({
    where: {
...
//改变子图层的顺序
layerRoute.post('/changeSort', (req, res) => {
...
// 修改图层属性
layerRoute.post('/updateLayer', (req, res) => {
  let change = {};
